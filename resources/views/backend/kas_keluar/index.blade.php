        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4>Data Kas Keluar <button class="btn btn-success" style="float: right" data-toggle="modal"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Form Data Kas Keluar</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form name="form_add" id="form_add" class="form-horizontal" action="{{ route('kas-pengeluaran.store') }}"
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                $('#tbl_list').DataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: '{{ url('kas-pengeluaran/getdata') }}',
                    type: "POST",
                    columns: [{
                            data: 'id'
                        },
                    ...
                    "drawCallback": function(settings, json) {
                        $('.edit').off("click").on("click", function() {
                            ...
                            $.ajax({
                                url: "{{ route('kas-pengeluaran.edit') }}?id=" + cek,
                                type: "GET",
                                dataType: "JSON",
                        ...
                        $('.destroy').off("click").on("click", function() {
                            ...
                            $.ajax({
                                url: "{{ url('kas-pengeluaran/destroy') }}/" + cek,
                                type: "POST",
                                success: function(data) {
                                    window.location =
                                        "{{ route('kas-pengeluaran.index') }}";
                                }
                            });
                        });
                    },
